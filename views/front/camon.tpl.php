...
if(isset($_POST['thanhtoan'])){
    $update = "UPDATE chitiethoadon SET pttt='cod' WHERE id_hoadon = $id_dathang";
    $query = mysqli_query($conn, $update);
}

if(isset($_GET['thanhtoan'])){
    if($_GET['thanhtoan']='momo'){
        $update = "UPDATE chitiethoadon SET pttt='momo atm' WHERE id_hoadon = $id_dathang";
        $query = mysqli_query($conn, $update);
    }
...
<html lang="en">
 ...
 <div>
        ...
        <div>
            <img src="../../templates/front/images/camon.svg"  >
            <div class="camon">
