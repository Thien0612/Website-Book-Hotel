        ...
        <!-- Giới thiệu khách sạn-->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div>
                    Với vị trí thuận tiện và các trang thiết bị hiện đại, các sảnh phòng họp tại HOTEL 2T hoàn toàn có thể đáp ứng nhu cầu đa dạng của những buổi gặp thân mật, hay những sự kiện lớn như tiệc cưới, hội họp. Ngoài ra, các sảnh phòng họp còn dược đồng hành cùng đội ngũ nhân viên đầy nhiệt huyết và kinh nghiệm để mang lại đầy đủ các yếu tố cần thiết của một sự kiện suôn sẻ.                      <br>
                    <div class="anh_amthuc"><img src="../../templates/front/images/hoinghi.jpg"></div>
                    <br>
                 </div>
                    </span>
                </div>  
                            ...
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-4">
                                        <a href="nhahangvaspa.tpl.php">
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            <div class="overlay-black overflow-hidden position-relative"> 
                                                <!-- ảnh phòng -->
                                                <img src="../../templates/front/images/amthuc.jpg" alt="" class="anh_phong">
                                            </div>
                                            <div class="featured-thumb-data shadow-one">
                                                <div class="p-2">
                                                    <div class="tieude" >
                                                        <!-- tiêu đề phòng -->
                                                        <span style="font-size:17px; color: #cf9b0a; font-weight:10px;"><b>Nhà hàng & Spa</b></span>
