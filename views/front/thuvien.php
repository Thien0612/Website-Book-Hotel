<?php
    ...
    function chaydi($id_dathang,$id_phong,$hoten,$sdt,$diachi,$ngaynhan, $ngaytra,$sophong,$tt,$capnhat,$dichvu){
        $conn= ketnoidb();
        $sql = "INSERT INTO chitiethoadon(id_hoadon, id_phong,HoTen,Sdt,DiaChi,NgayDen,NgayDi,SoPhong,ThanhTien,capnhat,dichvu) 
        VALUES ('$id_dathang','$id_phong','$hoten','$sdt','$diachi','$ngaynhan', '$ngaytra',$sophong,'$tt','$capnhat','$dichvu')";
    ...
    function taodonhang($id_user,$ngay_dat_hang,$tong_tien,$id_ttdp){
        $conn= ketnoidb();
        $sql = "INSERT INTO datphong(id_khachhang,NgayLapHoaDon,TongTien,id_ttdp) 
