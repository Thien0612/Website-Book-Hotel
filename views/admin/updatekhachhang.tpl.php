                        ...
                        <div class="card-header py-3">
                            ...
                            <form  method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row mb-3">
                                        ...
                                        <input type="text" name="sdt" class="form-control" id="inputText4" value="<?php echo $row_kh_update['Sdt']?>">
                                    </div>
                                    <div class="form-row mb-3">
                                    ...
                                    <div class="form-row mb-3">
                                        <label class="ml-3  font-weight-bold" for="inputText4">Trạng thái tài khoản </label><hr>
                                            <select class="form-control" required name="tttk">
                                                            <option value="<?php echo $row_kh_update['id_trangThai']?>"><?php echo $row_kh_update['trangthai']?></option>
                                                                <?php
                                                                    include("../../admin/khachhang.php");
                                                                    $t = $row_kh_update['id_trangThai'];
                                                                    $q = mysqli_query($conn,"SELECT * FROM trangthai_user WHERE id_trangthaiuser!='$t'");
                                                                    while($row_tttk=mysqli_fetch_assoc($q)){?>
                                                                        <option value= "<?php echo $row_tttk['id_trangthaiuser'];?>"><?php echo $row_tttk['trangthai'];?></option>
                                                                <?php }?>
											</select>	      
                                    </div>
